...
//--------------------------------------------------------------------------------
ReactionNetwork::ReactionNetwork() : temperature(0.0), networkSize(0), 
                                     reactionsEnabled(true), 
                                     dissociationsEnabled(true), numVClusters(0), 
...
ReactionNetwork::ReactionNetwork( 
                 ...
                 handlerRegistry(registry), temperature(0.0), networkSize(0), 
                 reactionsEnabled(true), dissociationsEnabled(true), 
                 numVClusters(0), numIClusters(0), numSuperClusters(0), 
                 maxVClusterSize(0), maxIClusterSize(0) 
{
...
//--------------------------------------------------------------------------------
void 
ReactionNetwork::updateConcentrationsFromArray(double* concentrations) 
{
// Local Declarations
...
//--------------------------------------------------------------------------------
void 
ReactionNetwork::askReactantsToReleaseNetwork(void) 
{
...
//--------------------------------------------------------------------------------
void 
ReactionNetwork::setTemperature(double temp) 
{
// Set the temperature
 temperature = temp;
...
//--------------------------------------------------------------------------------
double 
ReactionNetwork::getTemperature() const 
{
 return temperature;
}
...
//--------------------------------------------------------------------------------
IReactant* 
ReactionNetwork::get(const std::string& type, const int size) const 
{
// Local Declarations
...
ReactionNetwork::getAll( const std::string& name) const 
{
// Local Declarations
...
ReactionNetwork::getNames() const 
{
 return names;
}
...
//--------------------------------------------------------------------------------
const std::vector<std::string>& 
ReactionNetwork::getCompoundNames() const 
{
