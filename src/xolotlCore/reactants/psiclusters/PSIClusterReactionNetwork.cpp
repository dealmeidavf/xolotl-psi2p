...
//--------------------------------------------------------------------------------
PSIClusterReactionNetwork::PSIClusterReactionNetwork() : ReactionNetwork() 
{
...
//--------------------------------------------------------------------------------
void 
PSIClusterReactionNetwork::setTemperature(double temp) 
{
...
//--------------------------------------------------------------------------------
double 
PSIClusterReactionNetwork::getTemperature() const 
{
	return temperature;
}
...
//--------------------------------------------------------------------------------
IReactant* 
PSIClusterReactionNetwork::getSuper(const std::string& type,
		const std::vector<int>& sizes) const 
{
// Local Declarations
 static std::map<std::string, int> composition = { { heType, 0 },
...
//--------------------------------------------------------------------------------
void 
PSIClusterReactionNetwork::addSuper(std::shared_ptr<IReactant> reactant) 
{
// Local Declarations
	int numHe = 0, numV = 0, numI = 0;
	bool isMixed = false;
...
//--------------------------------------------------------------------------------
double 
PSIClusterReactionNetwork::getTotalAtomConcentration() 
{
...
//--------------------------------------------------------------------------------
double 
PSIClusterReactionNetwork::getTotalTrappedAtomConcentration() 
{
// Initial declarations
 double heliumConc = 0.0;
...
//--------------------------------------------------------------------------------
double 
PSIClusterReactionNetwork::getTotalVConcentration() 
{
// Initial declarations
 double vConc = 0.0;
...
//--------------------------------------------------------------------------------
double 
PSIClusterReactionNetwork::getTotalIConcentration() 
{
// Initial declarations
 double iConc = 0.0;
...
//--------------------------------------------------------------------------------
void 
PSIClusterReactionNetwork::computeAllFluxes(double *updatedConcOffset) 
{
// Initial declarations
 IReactant * cluster;
...
//--------------------------------------------------------------------------------
void 
PSIClusterReactionNetwork::computeAllPartials(double* vals, int* indices, int* size) 
{
// Initial declarations
