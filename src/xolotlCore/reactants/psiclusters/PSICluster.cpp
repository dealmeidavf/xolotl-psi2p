...
//--------------------------------------------------------------------------------
PSICluster::PSICluster() : Reactant() 
{
...
PSICluster::PSICluster( PSICluster &other ) :
            Reactant(other), reactingPairs(other.reactingPairs), 
...
//--------------------------------------------------------------------------------
double 
PSICluster::calculateDissociationConstant( const PSICluster& dissociatingCluster,
...
//--------------------------------------------------------------------------------
void 
PSICluster::dissociateCluster( PSICluster* dissociatingCluster, 
...
//--------------------------------------------------------------------------------
void 
PSICluster::combineClusters( std::vector<IReactant*>& reactants, 
...
// Initial declarations
 ...
 PSICluster* productCluster = nullptr; 
 PSICluster* secondCluster = nullptr;
...
getFullConnectivityVector(std::set<int> connectivitySet, int size) 
{
...
//--------------------------------------------------------------------------------
std::vector<int> 
PSICluster::getReactionConnectivity() const 
{
...
//--------------------------------------------------------------------------------
std::vector<int> 
PSICluster::getDissociationConnectivity() const 
{
// Create the full vector from the set and return it
...
//--------------------------------------------------------------------------------
void 
PSICluster::resetConnectivities() 
{
// Clear both sets
...
//--------------------------------------------------------------------------------
void 
PSICluster::setReactionNetwork( const std::shared_ptr<IReactionNetwork> reactionNetwork)
{
...
//--------------------------------------------------------------------------------
double 
PSICluster::getHeMomentum() const 
{
 return 0.0;
}
...
//--------------------------------------------------------------------------------
double 
PSICluster::getDissociationFlux() const 
{
// Initial declarations
int nPairs = 0;
double flux = 0.0;
...
//--------------------------------------------------------------------------------
double 
PSICluster::getEmissionFlux() const 
{
// Initial declarations
int nPairs = 0;
double flux = 0.0;
...
//--------------------------------------------------------------------------------
double 
PSICluster::getProductionFlux() const 
{
// Local declarations
double flux = 0.0;
int nPairs = 0;
...
//--------------------------------------------------------------------------------
double 
PSICluster::getCombinationFlux() const 
{
// Local declarations
double flux = 0.0;
int nReactants = 0;
...
//--------------------------------------------------------------------------------
std::vector<double> 
PSICluster::getPartialDerivatives() const 
{
// Local Declarations
...
//--------------------------------------------------------------------------------
void 
PSICluster::getPartialDerivatives( std::vector<double> & partials ) const 
{
// Get the partial derivatives for each reaction type
getProductionPartialDerivatives(partials);
getCombinationPartialDerivatives(partials);
...
//--------------------------------------------------------------------------------
void 
PSICluster::getProductionPartialDerivatives( std::vector<double> & partials) const 
{
// Initial declarations
...
//--------------------------------------------------------------------------------
void 
PSICluster::getCombinationPartialDerivatives( std::vector<double>& partials ) const 
{
// Initial declarations
...
//--------------------------------------------------------------------------------
void 
PSICluster::getDissociationPartialDerivatives( std::vector<double> & partials ) const 
{
// Initial declarations
...
//--------------------------------------------------------------------------------
void 
PSICluster::getEmissionPartialDerivatives( std::vector<double> & partials ) const 
{
// Initial declarations
int numPairs = 0, index = 0;
...
//--------------------------------------------------------------------------------
void 
PSICluster::setDiffusionFactor( const double factor ) 
{
...
//--------------------------------------------------------------------------------
void 
PSICluster::setMigrationEnergy( const double energy ) 
{
...
//--------------------------------------------------------------------------------
double 
PSICluster::getLeftSideRate() const 
{
...
//--------------------------------------------------------------------------------
std::vector<int> 
PSICluster::getConnectivity() const 
{
...
//--------------------------------------------------------------------------------
void 
PSICluster::computeRateConstants() 
{
...
//--------------------------------------------------------------------------------
void 
PSICluster::updateRateConstants() 
{
// Local declarations
PSICluster *firstReactant = nullptr, *secondReactant = nullptr,
*combiningReactant = nullptr, *dissociatingCluster = nullptr,
