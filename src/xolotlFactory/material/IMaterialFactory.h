 ...
 */
   virtual void 
   initializeMaterial( xolotlCore::Options& options ) = 0;
 ...
 * @return The flux handler.
 */
   virtual std::shared_ptr<xolotlCore::IFluxHandler> 
 ...
 * @return The advection handlers.
 */
   virtual std::vector<std::shared_ptr<xolotlCore::IAdvectionHandler> > 
 ...
 * @return The diffusion handler.
 */
   virtual std::shared_ptr<xolotlCore::IDiffusionHandler> 
 ...
 */
   virtual std::shared_ptr<xolotlCore::ITrapMutationHandler> 
 ...
 */
   ...
   createMaterialFactory( const std::string& materialType, int dimension );
