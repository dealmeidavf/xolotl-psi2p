 ...
 */
   void 
   initializeMaterial( xolotlCore::Options& options )
   {
 ...
 *  @return The flux handler.
 */
   std::shared_ptr<xolotlCore::IFluxHandler> 
 ...
 *  @return The advection handler.
 */
   std::vector<std::shared_ptr<xolotlCore::IAdvectionHandler> > 
 ...
 *  @return The diffusion handler.
 */
   std::shared_ptr<xolotlCore::IDiffusionHandler> 
 ...
 */
   std::shared_ptr<xolotlCore::ITrapMutationHandler> 
