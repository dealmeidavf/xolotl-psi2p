...
/**
 * Realizes the IReactionHandlerFactory interface. Handles the network for a 
 * NE problem (vfda: what problem?).
 */
 ...
 */
   void 
   initializeReactionNetwork( xolotlCore::Options& options,
 ...
 * @return The network loader.
 */
   std::shared_ptr<xolotlCore::INetworkLoader> 
   getNetworkLoaderHandler() const 
   {
 ...
 * @return The network.
 */
   std::shared_ptr<xolotlCore::IReactionNetwork> 
